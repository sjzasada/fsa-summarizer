...
class ScoreTable extends Component {
  ...
  componentWillReceiveProps(nextProps){
    if(nextProps.authority !== this.props.authority){
        ...
        let url = 'http://api.ratings.food.gov.uk/Establishments?pageSize=0&localAuthorityId='+nextProps.authority
        console.log(url)
    fetch(url, {
        method: 'GET',
        headers: {
  ...
  render() {
    ...
    return ( < div >
      ...
      <ScoreTableBody establishments={establishments} scheme={this.props.scheme} />
      </Table>
< /div>)
    }
  }
